                  ...
                  <ul className='list-wrap mb-3'>
                    ...
                    <li className='col-3'>
                      <span className='homeblog-link-icon-phone'>
                        <a onClick={() => handleWhatsAppShare(item.seo_slug, item.title, item.img, item.sub_title, item.category.type2)}>
                          <FontAwesomeIcon icon={faPhone} />
                        </a>
                      </span>
                      <span className='homeblog-link-icon-facebook'>
                        <a onClick={() => handleFacebookShare(item.seo_slug, item.title, item.img, item.sub_title, item.category.type2)}>
                          <FontAwesomeIcon icon={faFacebookF} />
                        </a>
                      </span>
                      <span className='homeblog-link-icon-twitter'>
                        <a onClick={() => handleTwitterShare(item.seo_slug, item.title, item.img, item.sub_title, item.category.type2)}>
